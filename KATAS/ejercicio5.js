...
const lol = streamers.filter(
  (loleros) => loleros.gameMorePlayed === 'League of Legends'
)
console.log(lol)
...
const u = streamers.filter((uistas) => uistas.name.includes('u'))
console.log(u)
...
const transform = streamers.filter((legends) => {
  if (legends.gameMorePlayed.includes('Legends') && legends.age > 35) {
